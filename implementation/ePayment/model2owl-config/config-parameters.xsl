...
<!--    Set of variables for convention report-->
    ...
    <xsl:variable name="moduleReference" select="'pay'"/>
    <!--    rdfs:label -->
    <xsl:variable name="ontologyLabelCore" select="'eProcurement Ontology Payment - core'"/>
    <xsl:variable name="ontologyLabelRestrictions" select="'eProcurement Ontology Payment - core restrictions'"/>
    <xsl:variable name="ontologyLabelShapes" select="'eProcurement Ontology Payment - core shapes'"/>
    <!--    dct:title -->
    <xsl:variable name="ontologyTitleCore" select="'eProcurement Ontology Payment - core'"/>
    <xsl:variable name="ontologyTitleRestrictions" select="'eProcurement Ontology Payment - core restrictions'"/>
    <xsl:variable name="ontologyTitleShapes" select="'eProcurement Ontology Payment - core shapes'"/>
    <!--    dct:description-->
    <xsl:variable name="ontologyDescriptionCore"
        select="'The eProcurement Ontology Payment core describes the concepts and properties representing the European Public Procurement Payment domain. The provision of these semantics offers the basis for a common understanding of the domain for all stakeholders ensuring the quality of data exchange and transparency. The ontology restrictions are published in a separate artefact.'"/>
    <xsl:variable name="ontologyDescriptionRestrictions"
        select="'The eProcurement Ontology Payment core restrictions provides the restrictions and the inference-related specifications on the concepts and properties in the eProcurement Ontology Payment core.'"/>
    <xsl:variable name="ontologyDescriptionShapes"
        select="'The eProcurement Ontology Payment core shapes provides the generic datashape specifications for the eProcurement Ontology Payment core.'"/>
    <!--    rdfs:seeAlso -->
