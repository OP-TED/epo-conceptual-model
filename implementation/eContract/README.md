...
eContract is the module of ePO ontology containing the classes related to the Electronic Contract.
...
- The *respec_resources* folder contains the assets and templates used to generate the ReSpec documentation for the eContract module.
