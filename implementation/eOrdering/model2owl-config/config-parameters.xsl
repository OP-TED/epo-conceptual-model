...
<!--    Set of variables for convention report-->
    ...
    <xsl:variable name="ontologyTitleShapes" select="'eProcurement Ontology Ordering - core shapes'"/>
    <!--    dct:description-->
    <xsl:variable name="ontologyDescriptionCore"
        select="'The eProcurement Ontology Ordering core describes the concepts and properties representing the European Public Procurement Ordering domain. The provision of these semantics offers the basis for a common understanding of the domain for all stakeholders ensuring the quality of data exchange and transparency. The ontology restrictions are published in a separate artefact.'"/>
    <xsl:variable name="ontologyDescriptionRestrictions"
        select="'The eProcurement Ontology Ordering core restrictions provides the restrictions and the inference-related specifications on the concepts and properties in the eProcurement Ontology Ordering core.'"/>
    <xsl:variable name="ontologyDescriptionShapes"
        select="'The eProcurement Ontology Ordering core shapes provides the generic datashape specifications for the eProcurement Ontology Ordering core.'"/>
    <!--    rdfs:seeAlso -->
