...
<!--    Set of variables for convention report-->
    ...
    <xsl:variable name="moduleReference" select="'qua'"/>
    <!--    rdfs:label -->
    <xsl:variable name="ontologyLabelCore" select="'eProcurement Ontology Qualification - core'"/>
    <xsl:variable name="ontologyLabelRestrictions" select="'eProcurement Ontology Qualification - core restrictions'"/>
    <xsl:variable name="ontologyLabelShapes" select="'eProcurement Ontology Qualification - core shapes'"/>
    <!--    dct:title -->
    <xsl:variable name="ontologyTitleCore" select="'eProcurement Ontology Qualification - core'"/>
    <xsl:variable name="ontologyTitleRestrictions" select="'eProcurement Ontology Qualification - core restrictions'"/>
    <xsl:variable name="ontologyTitleShapes" select="'eProcurement Ontology Qualification - core shapes'"/>
    <!--    dct:description-->
    <xsl:variable name="ontologyDescriptionCore"
        select="'The eProcurement Ontology Qualification core describes the concepts and properties representing the European Public Procurement Qualification domain. The provision of these semantics offers the basis for a common understanding of the domain for all stakeholders ensuring the quality of data exchange and transparency. The ontology restrictions are published in a separate artefact.'"/>
    <xsl:variable name="ontologyDescriptionRestrictions"
        select="'The eProcurement Ontology Qualification core restrictions provides the restrictions and the inference-related specifications on the concepts and properties in the eProcurement Ontology Qualification core.'"/>
    <xsl:variable name="ontologyDescriptionShapes"
        select="'The eProcurement Ontology Qualification core shapes provides the generic datashape specifications for the eProcurement Ontology Qualification core.'"/>
    <!--    rdfs:seeAlso -->
    ...
    <!--    owl:versionInfo -->
    <xsl:variable name="versionInfo" select="'5.1.0'"/>
    <!--    bibo:status-->
    <xsl:variable name="ontologyStatus" select="'Semantic Specification Release'"/>
    <!--    owl:priorVersion -->
    <xsl:variable name="priorVersion" select="'5.0.0'"/>
